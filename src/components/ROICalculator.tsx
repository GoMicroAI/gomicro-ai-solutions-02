...
const SegmentSlider = ({ visual, recording, other, onChange }: { visual: number; recording: number; other: number; onChange: (s: Segments) => void }) => {
  ...
  return (
    <div style={{ marginTop: 16, padding: 12, paddingTop: 18, borderRadius: 10, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', minHeight: 180 }}>
      ...
      <div style={s.container}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ ...s.card, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginTop: 8 }}><BoxInput label="QC Staff" value={qcStaff} onChange={setQcStaff} unit="ppl" width={72} step="0.5" hint="People doing QC" /></div>
