...
const SegmentSlider = ({ visual, recording, other, onChange }: { visual: number; recording: number; other: number; onChange: (s: Segments) => void }) => {
  ...
  return (
    <div style={{ marginTop: 12, padding: 12, paddingTop: 18, borderRadius: 10, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', minHeight: 180 }}>
      ...
      <p style={{ fontSize: 11, color: BRAND.textMuted, marginBottom: 0 }}>% of QC time on visual inspection + record keeping</p>
      <div style={{ display: 'flex', fontSize: 10, fontWeight: 600, marginBottom: 4, marginTop: 'auto', userSelect: 'none', fontFamily: 'Arial, sans-serif' }}>
...
const RejectionCauseSplitSlider = ({ qcErrorPct, handlingPct, onChange }: { qcErrorPct: number; handlingPct: number; onChange: (v: number) => void }) => {
  ...
  return (
    <div style={{ marginTop: 12, padding: 12, paddingTop: 18, borderRadius: 10, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', minHeight: 180 }}>
      ...
      <p style={{ fontSize: 11, color: BRAND.textMuted, marginBottom: 0 }}>What percentage of rejections are due to QC errors vs handling issues? (refrigeration, late trucks, rough handling)</p>
      <div style={{ display: 'flex', fontSize: 10, fontWeight: 600, marginBottom: 4, marginTop: 'auto', userSelect: 'none', fontFamily: 'Arial, sans-serif' }}>
          ...
          <div className="fade-in">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16, marginBottom: 16 }}>
              ...
              <div style={{ ...s.card, border: '1px solid rgba(74,222,128,0.15)', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 4, marginTop: 20 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 4, marginTop: 40 }}>
